...
class Ludo extends JFrame
{
  ...
  public Ludo()
  {
	...
	setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        bg=new JLabel(new ImageIcon(getClass().getResource("images/pics/wp4.jpg")));
	bg.setBounds(0,0,600,650);
	add(bg);
  	bg.setLayout(null);
        VA.labg=new JLabel(new ImageIcon(getClass().getResource("images/ludoking.png")));
  ...
  void addDoor()
  {
    for(int i=0;i<4;i++)
    {
	VA.door[i]=new JLabel(new ImageIcon(getClass().getResource("images/door.png")));
  ...
  void addStars()
  {
	...
	{
          if(i%2==1)
	    ly=new JLabel(new ImageIcon(getClass().getResource("images/pics/sb.png")));
	  else
	    ly=new JLabel(new ImageIcon(getClass().getResource("images/pics/sm.png")));
  ...
  void setWinner()
  {
	 VA.lawinner=new JLabel(new ImageIcon(getClass().getResource("pics/images/winner.jpg")));
  ...
  void changeIcon()
  {
	ImageIcon icon=new ImageIcon(getClass().getResource("pics/d1.jpg"));
  ...
  void startMove()
  {
	...
	EX.exp20();
	VA.dicebc.setIcon(new ImageIcon(getClass().getResource("pics/images/"+VA.yn+".jpg")));
