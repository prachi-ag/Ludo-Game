...
class MainClass extends JFrame
{
  ...
  JButton bt=new JButton("Play",new ImageIcon(getClass().getResource("pics/images/play.png")));
  ButtonGroup bg=new ButtonGroup();
  JLabel la=new JLabel(new ImageIcon(getClass().getResource("pics/images/wp3.jpg")));
  public MainClass()
  {
	super("Ludo Ping");
	setSize(600,600);
